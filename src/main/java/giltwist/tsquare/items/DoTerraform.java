...
public class DoTerraform {

	public static void sphere(EntityPlayer player, int meltFaces, int growFaces) {
		if (!player.isSwingInProgress) {
			...
			if (center == null) {
				...
				BlockControl.terraformBlocks(player, toReplace, meltFaces,growFaces);
			}
